...
class Sigmoid:
    ...
    def activate(self, values):
        ...
        # Modify strength using the sigmoid activation function and
        ...
        sigmoid = 1 / (1 + np.exp(-1 * self.last_input))
...
def test():
    ...
    print '1) Exepected weights: {}'.format(np.array([2.990752, -2.018496, 0.972257]))
    print '   Produced weights: {}'.format(u1.weights)
    ...
    print '2) Exepected weights: {}'.format(np.array([-0.030739, 2.984961, -1.027437]))
    print '   Produced weights: {}'.format(u2.weights)
